        ...
        <GlowCard>
          <div class="p-8">
            ...
            <form @submit.prevent="handleRegister" class="space-y-5">
              ...
              <div class="flex items-start gap-3">
                <input
                  ...
                  type="checkbox"
                  required
                  class="mt-1 w-4 h-4 rounded border-white/10 bg-zinc-900 text-orange-500 focus:ring-orange-500/50"
                />
                <label class="text-xs text-zinc-500">
                  <NuxtLink to="/legal/terms" class="text-orange-400 hover:text-orange-300">Hizmet Şartları</NuxtLink>
                  ve
                  <NuxtLink to="/legal/privacy" class="text-orange-400 hover:text-orange-300">Gizlilik Politikası</NuxtLink>'nı
            ...
            <p class="text-center text-sm text-zinc-500 mt-6">
              ...
              <NuxtLink to="/auth/login" class="text-orange-400 hover:text-orange-300 transition-colors font-medium">
                Giriş yapın.
              </NuxtLink>
            </p>
