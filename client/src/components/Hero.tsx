  ...
  return (
    <>
      ...
      <section className="relative flex items-center justify-center pt-40 pb-20 overflow-hidden">
        ...
        <div 
          className="absolute top-1/4 left-1/4 w-125 h-125 rounded-full blur-3xl animate-float pointer-events-none" 
          style={{ background: 'radial-gradient(circle, rgba(100,107,242,0.20) 0%, transparent 70%)' }}
        />
        <div 
          className="absolute bottom-[15%] right-1/4 w-125 h-125 rounded-full blur-3xl animate-float pointer-events-none" 
