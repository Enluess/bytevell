...
export default function AboutPage() {
  return (
    <LegalPageLayout title="Hakkımızda" lastUpdated="Ağustos 2026">
      <h2>Biz Kimiz?</h2>
      <p>Bytevell, yenilikçi altyapısı ve müşteri odaklı vizyonuyla kurumsal ve bireysel kullanıcılara yüksek performanslı barındırma hizmetleri sunan bir teknoloji şirketidir.</p>
